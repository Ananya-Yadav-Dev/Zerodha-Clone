...
const uri =
  "mongodb+srv://nandabhavesh2003:3MYEUelVnOwvaztN@maintenance-prediction.l48gtfa.mongodb.net/?retryWrites=true&w=majority&appName=Maintenance-Prediction";
...
async function pushData() {
  try {
    ...
    const database = client.db("FinanceDB");
    ...
    // Insert data
    await watchlistCollection.insertMany(watchlist);
